        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-24 items-center'>
            <div>
                ...
                <p className='mt-8 max-w-xl text-lg leading-8 text-muted-foreground'>
                    ...
                    laborum maiores possimus illum reprehenderit aut delectus veniam cum perferendis unde sint
                    doloremque non nam.
                </p>
    ...
    return (
        <section>
            ...
            <p className='mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero hic distinctio ducimus temporibus nobis
                autem laboriosam repellat, magni fugiat minima excepturi neque, tenetur possimus nihil atque! Culpa
                nulla labore nam?
            </p>
        </section>
    );
